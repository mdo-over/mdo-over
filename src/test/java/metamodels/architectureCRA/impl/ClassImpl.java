 ...
 * </p>
 * <ul>
 *   <li>{@link metamodels.architectureCRA.impl.ClassImpl#getEncapsulates <em>Encapsulates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassImpl extends NamedElementImpl implements metamodels.architectureCRA.Class {
	/**
	...
	public EList<Feature> getEncapsulates() {
		if (encapsulates == null) {
			encapsulates = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(Feature.class, this, ArchitectureCRAPackage.CLASS__ENCAPSULATES, ArchitectureCRAPackage.FEATURE__IS_ENCAPSULATED_BY);
		}
		return encapsulates;
	}
