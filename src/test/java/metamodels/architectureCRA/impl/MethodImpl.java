 ...
 * </p>
 * <ul>
 *   <li>{@link metamodels.architectureCRA.impl.MethodImpl#getDataDependency <em>Data Dependency</em>}</li>
 *   <li>{@link metamodels.architectureCRA.impl.MethodImpl#getFunctionalDependency <em>Functional Dependency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodImpl extends FeatureImpl implements Method {
	...
	public EList<Attribute> getDataDependency() {
		if (dataDependency == null) {
			dataDependency = new EObjectResolvingEList<Attribute>(Attribute.class, this, ArchitectureCRAPackage.METHOD__DATA_DEPENDENCY);
		}
	...
	public EList<Method> getFunctionalDependency() {
		if (functionalDependency == null) {
			functionalDependency = new EObjectResolvingEList<Method>(Method.class, this, ArchitectureCRAPackage.METHOD__FUNCTIONAL_DEPENDENCY);
		}
