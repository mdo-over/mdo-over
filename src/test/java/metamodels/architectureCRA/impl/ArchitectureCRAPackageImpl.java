...
import metamodels.architectureCRA.ArchitectureCRAFactory;
...
public class ArchitectureCRAPackageImpl extends EPackageImpl implements ArchitectureCRAPackage {
	 ...
	 * @see metamodels.architectureCRA.ArchitectureCRAPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 *
	 * <p>This method is used to initialize {@link ArchitectureCRAPackage#eINSTANCE} when that field is accessed.
	...
	public static ArchitectureCRAPackage init() {
		if (isInited) return (ArchitectureCRAPackage)EPackage.Registry.INSTANCE.getEPackage(ArchitectureCRAPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredArchitectureCRAPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ArchitectureCRAPackageImpl theArchitectureCRAPackage = registeredArchitectureCRAPackage instanceof ArchitectureCRAPackageImpl ? (ArchitectureCRAPackageImpl)registeredArchitectureCRAPackage : new ArchitectureCRAPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, metamodels.architectureCRA.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Encapsulates(), this.getFeature(), this.getFeature_IsEncapsulatedBy(), "encapsulates", null, 0, -1, metamodels.architectureCRA.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
